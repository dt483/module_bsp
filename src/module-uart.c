...
{
	module_UART_console_instance = uartInstance;
}

void module_UART_sendConsole (char data)
{
	module_UART_send(module_UART_console_instance, data);
}
